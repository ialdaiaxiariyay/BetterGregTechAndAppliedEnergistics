...
public class TipsLang {
    ...
    public static void init(UnifiedLanguageProvider provider) {
        provider.add("bettergtae.gui.circuit.configurator.tooltip","Configure circuit values for each Internal Slot","配置每个内部槽位的电路值");
        provider.add("bettergtae.gui.circuit.slot_tooltip","Slot %d: click to change circuit configuration","槽位 %d：点击更改电路配置");
